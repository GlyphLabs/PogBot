...
class Text(Cog):
    ...
    @slash_command(description="Reverse the text!")
    ...
    @slash_command(description="Convert text to binary!", aliases=["ttb"])
    ...
    @slash_command(description="Convert binary to text!", aliases=["btt"])
